...
# Serve the real training/evaluation figures (ROC curve, PR curve, confusion matrices, etc.)
# generated by the notebook and checked into backend/models/figures/. Read-only, static, and
# contains no request data — only pre-existing evaluation artifacts.
_figures_dir = settings.MODELS_DIR / "figures"
